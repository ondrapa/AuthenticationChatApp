...
import com.example.chineseappfinal.ui.theme.PaletteRed1
import com.example.chineseappfinal.ui.theme.PaletteRed2
import com.example.chineseappfinal.ui.theme.PaletteYellow2
import com.example.chineseappfinal.viewmodel.ChatViewModel
...
fun ChatScreen(
    ...
    Column {
        Row(
            ...
            Text(
                text = User.ThisUser.currentChat,
                fontSize = 25.sp,
                color = Color.White
            )
        }
            ...
            Column(
                ...
                LazyColumn(
                    ...
                    items(state.messages) { message ->
                        val isOwnMessage = message.username == User.ThisUser.username
                        Box(
                            ...
                            Column(
                                modifier = Modifier
                                    ...
                                    .drawBehind {
                                        ...
                                        drawPath(
                                            path = trianglePath,
                                            color = if (isOwnMessage) PaletteYellow2 else PaletteRed1
                                        )
                                    }
                                    .background(
                                        color = if (isOwnMessage) PaletteYellow2 else PaletteRed1,
